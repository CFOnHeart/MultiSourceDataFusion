...
public class FE2KeywordsController {
    ...
    private void exportDataClicked(MouseEvent event){
        ...
        DatabaseOperations.write(DatabaseOperations.outputTableNames[1], DatabaseOperations.dataColumn, partedDocs);
...
//        docs.add(doc); docs.add(doc); docs.add(doc);
        ...
        docs = DatabaseOperations.read(DatabaseOperations.originalDataTables[1], DatabaseOperations.dataColumn);
        dbname.setText("数据库: "+DatabaseOperations.DBNAME);
        dbname_.setText("数据库: "+DatabaseOperations.DBNAME);
        dataOrigin.setText("源数据表格: "+DatabaseOperations.originalDataTables[1]);
        dataOutput.setText("导出数据表格: "+DatabaseOperations.outputTableNames[1]);

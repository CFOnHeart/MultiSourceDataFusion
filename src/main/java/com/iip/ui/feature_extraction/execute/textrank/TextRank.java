...
public class TextRank {
    ...
    public static String tmpAppendKeyWords = "";
    public static List<String> topKDocs = new ArrayList<String>();
    TextRankGraph graph ;
    double d;  // 阻尼系数
    public TextRank(){
        d = 0.5;
...
//            com.iip.ui.feature_extraction.execute.Participle.print("$"+tmpWord+"#");
            tmpAppendKeyWords += tmpWord + ", ";
            keys.add(tmpWord);
        }
        return keys;
    }
    ...
    public static String main(List<String> docs){  //(String [] args)
...
//        docs.add(documents); docs.add(documents);
//        List<String> docs_new = new ArrayList<>();
//        for(String doc: docs){
//            docs_new.add(doc);
//        }
        com.iip.ui.feature_extraction.execute.Participle.print(docs.size());
        for(String doc: topKDocs(docs, 5)){
            com.iip.ui.feature_extraction.execute.Participle.print("##$"+doc);
            r += doc;
        }
        return r;
    }

    public static List<String> topKDocs(List<String> docs, int topK){
        for(String doc: docs){
            List<String> keys = topKWords(doc, topK);  // split words
//            com.iip.ui.feature_extraction.execute.Participle.print(docs+"\n#"+tmpAppendKeyWords+"#"+keys.size());
            topKDocs.add(tmpAppendKeyWords);
        }
        return topKDocs;
    }
}
